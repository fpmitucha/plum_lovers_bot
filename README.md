...
- `/anon` — отправка анонимных сообщений администраторам (приватно) или на публикацию в чат после их одобрения.
...
- Системный `ffmpeg` (CLI), чтобы конвертировать аудио для «Аудио → текст»
